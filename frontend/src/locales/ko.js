...
export default {
  ...
  'New PR:': '신기록:',
  'Nice!': '좋아요!',
  'Mark all exercises done': '모든 운동을 완료로 표시',
  'Checks off every remaining set at the numbers already in the rows.': '각 줄에 이미 입력된 숫자로 남은 세트를 모두 체크합니다.',
  '{0} of {1} sets will be logged.': '{1}세트 중 {0}세트가 기록됩니다.',
  'Finish with nothing logged': '기록 없이 종료',
  'Keep training': '계속 운동하기',
  '{0} set is still unchecked.': '{0}세트가 아직 체크되지 않았습니다.',
  '{0} sets are still unchecked.': '{0}세트가 아직 체크되지 않았습니다.',
  'Mark them done if you trained them, delete the ones you didn’t, then confirm how long the session took.': '했다면 체크하고, 하지 않은 세트는 삭제한 뒤 운동 시간을 확인하세요.',
  'Every set is checked off. Delete anything that shouldn’t be saved, then confirm how long the session took.': '모든 세트가 체크되었습니다. 저장하지 않을 것을 삭제한 뒤 운동 시간을 확인하세요.',
  'Review & delete sets': '세트 확인 및 삭제',
  '{0} deleted': '{0}개 삭제됨',
  'Delete the unchecked set': '체크되지 않은 세트 삭제',
  'Delete the {0} unchecked sets': '체크되지 않은 {0}세트 삭제',
  '1 set will be deleted.': '세트 1개가 삭제됩니다.',
  '{0} sets will be deleted.': '세트 {0}개가 삭제됩니다.',
  'unchecked': '체크 안 됨',
  'Delete set': '세트 삭제',
  'Restore set': '세트 복원',
  'Restore exercise': '운동 복원',
  'Finish workout': '운동 마치기',
  'Start workout': '운동 시작',
  'today is {0}': '오늘은 {0}',
  ...
  'Log a past workout': '지난 운동 기록하기',
  'Pick the day you trained. For anything older, open the calendar and tap the day.': '운동한 날을 고르세요. 더 오래된 날은 캘린더를 열어 그 날을 누르세요.',
  'planned: {0}': '계획: {0}',
  'What did you train? The sets come in at your usual numbers — correct them, then finish as normal.': '무엇을 했나요? 세트는 평소 숫자로 채워집니다 — 고친 뒤 평소처럼 마치세요.',
  'planned': '계획됨',
  'add the exercises yourself': '운동은 직접 추가',
  'Finish or discard the workout you have open first': '열려 있는 운동을 먼저 끝내거나 취소하세요',
  'Log a workout for this day': '이 날의 운동 기록하기',
  'Add an exercise you forgot': '빠뜨린 운동 추가',
  'Added to {0}': '{0}에 추가됨',
  'logging {0}': '{0} 기록 중',
  'Save this workout': '이 운동 저장',
  'Saved to {0}': '{0}에 저장됩니다',
  '{0} — logging {1}': '{0} — {1} 기록 중',
  ...
  'Finish workout · {0} exercises done': '운동 종료 · {0}개 운동 완료',
  ...
  'Duplicate exercise': '운동 복제',
  '{0} (copy)': '{0} (복사본)',
  'A copy of “{0}” that is yours to change — rename it, fix the muscles, set the weight you actually use.': '“{0}”의 복사본입니다. 이름을 바꾸고, 근육을 고치고, 실제로 쓰는 무게를 넣으세요.',
  'It behaves like any other exercise. Everything here can be changed later.': '다른 운동과 똑같이 동작합니다. 여기 있는 모든 항목은 나중에 바꿀 수 있습니다.',
  'Body part': '신체 부위',
  ...
  'Show the animation': '애니메이션 표시',
  'The copied clip from “{0}”.': '“{0}”에서 복사한 클립.',
  'Create copy': '복사본 만들기',
  'Duplicate & edit': '복제 후 편집',
  ...
  'No entries yet — log your weight to start the curve.': '아직 기록이 없습니다 — 체중을 기록해 곡선을 시작하세요.',
  'Edit this workout': '이 운동 편집',
}
