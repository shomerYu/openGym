...
export default {
  ...
  'Mark them done if you trained them, then confirm how long the session took.': '했다면 체크하고, 운동 시간을 확인하세요.',
  'Every set is checked off. Confirm how long the session took.': '모든 세트가 체크되었습니다. 운동 시간을 확인하세요.',
  'Finish workout': '운동 마치기',
  'Start workout': '운동 시작',
  'today is {0}': '오늘은 {0}',
