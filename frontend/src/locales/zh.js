...
export default {
  ...
  'Mark them done if you trained them, then confirm how long the session took.': '如果你练了就勾选它们，然后确认本次训练用了多久。',
  'Every set is checked off. Confirm how long the session took.': '所有组都已勾选。确认本次训练用了多久。',
  'Finish workout': '结束训练',
  'Start workout': '开始训练',
  'today is {0}': '今天是{0}',
