...
export default {
  ...
  'New PR:': '新纪录：',
  'Nice!': '太棒了！',
  'Mark all exercises done': '将所有动作标记为完成',
  'Checks off every remaining set at the numbers already in the rows.': '按各行中已有的数值勾选剩余的每一组。',
  '{0} of {1} sets will be logged.': '将记录 {1} 组中的 {0} 组。',
  'Finish with nothing logged': '不记录任何内容并结束',
  'Keep training': '继续训练',
  '{0} set is still unchecked.': '还有 {0} 组未勾选。',
  '{0} sets are still unchecked.': '还有 {0} 组未勾选。',
  'Mark them done if you trained them, delete the ones you didn’t, then confirm how long the session took.': '练了的就勾选，没练的删掉，然后确认本次训练用了多久。',
  'Every set is checked off. Delete anything that shouldn’t be saved, then confirm how long the session took.': '所有组都已勾选。删掉不需要保存的内容，然后确认训练时长。',
  'Review & delete sets': '检查并删除组',
  '{0} deleted': '已删除 {0}',
  'Delete the unchecked set': '删除未勾选的那一组',
  'Delete the {0} unchecked sets': '删除未勾选的 {0} 组',
  '1 set will be deleted.': '将删除 1 组。',
  '{0} sets will be deleted.': '将删除 {0} 组。',
  'unchecked': '未勾选',
  'Delete set': '删除该组',
  'Restore set': '恢复该组',
  'Restore exercise': '恢复该动作',
  'Finish workout': '结束训练',
  'Start workout': '开始训练',
  'today is {0}': '今天是{0}',
  ...
  'Log a past workout': '补记一次过去的训练',
  'Pick the day you trained. For anything older, open the calendar and tap the day.': '选择你训练的那天。更早的日子请打开日历并点按那天。',
  'planned: {0}': '计划：{0}',
  'What did you train? The sets come in at your usual numbers — correct them, then finish as normal.': '你练了什么？各组会按你平时的数字带出来 —— 改好后照常结束。',
  'planned': '计划',
  'add the exercises yourself': '自己添加动作',
  'Finish or discard the workout you have open first': '请先结束或放弃正在进行的训练',
  'Log a workout for this day': '补记这天的训练',
  'Add an exercise you forgot': '补一个漏记的动作',
  'Added to {0}': '已添加到 {0}',
  'logging {0}': '补记 {0}',
  'Save this workout': '保存这次训练',
  'Saved to {0}': '将保存到 {0}',
  '{0} — logging {1}': '{0} — 补记 {1}',
  ...
  'Finish workout · {0} exercises done': '结束训练 · 已完成 {0} 个动作',
  ...
  'Duplicate exercise': '复制动作',
  '{0} (copy)': '{0}（副本）',
  'A copy of “{0}” that is yours to change — rename it, fix the muscles, set the weight you actually use.': '“{0}”的副本，归你修改——重命名、修正肌群、设置你实际使用的重量。',
  'It behaves like any other exercise. Everything here can be changed later.': '它和其他动作一样。这里的所有内容之后都可以修改。',
  'Body part': '身体部位',
  ...
  'What a new plan starts this exercise at. Leave at 0 to decide per plan.': '新计划从这个重量开始。保持为 0 则在每个计划中单独决定。',
  'Show the animation': '显示动画',
  'The copied clip from “{0}”.': '从“{0}”复制的动画。',
  'Create copy': '创建副本',
  'Duplicate & edit': '复制并编辑',
  ...
  'No entries yet — log your weight to start the curve.': '还没有记录 —— 记下体重开始这条曲线。',
  'Edit this workout': '编辑这次训练',
}
