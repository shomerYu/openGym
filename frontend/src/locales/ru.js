...
export default {
  ...
  'Mark them done if you trained them, then confirm how long the session took.': 'Отметь их, если выполнил, затем подтверди длительность тренировки.',
  'Every set is checked off. Confirm how long the session took.': 'Все подходы отмечены. Подтверди длительность тренировки.',
  'Finish workout': 'Завершить тренировку',
