...
export default {
  ...
  'New PR:': 'Новый рекорд:',
  'Nice!': 'Отлично!',
  'Mark all exercises done': 'Отметить все упражнения выполненными',
  'Checks off every remaining set at the numbers already in the rows.': 'Отмечает каждый оставшийся подход с числами, которые уже стоят в строках.',
  '{0} of {1} sets will be logged.': 'Будет записано {0} из {1} подходов.',
  'Finish with nothing logged': 'Завершить без записей',
  'Keep training': 'Продолжить тренировку',
  '{0} set is still unchecked.': '{0} подход ещё не отмечен.',
  '{0} sets are still unchecked.': '{0} подходов ещё не отмечено.',
  'Mark them done if you trained them, delete the ones you didn’t, then confirm how long the session took.': 'Отметь те, что выполнил, удали остальные, затем подтверди длительность тренировки.',
  'Every set is checked off. Delete anything that shouldn’t be saved, then confirm how long the session took.': 'Все подходы отмечены. Удали то, что не нужно сохранять, и подтверди длительность.',
  'Review & delete sets': 'Проверить и удалить подходы',
  '{0} deleted': 'удалено: {0}',
  'Delete the unchecked set': 'Удалить неотмеченный подход',
  'Delete the {0} unchecked sets': 'Удалить неотмеченные подходы: {0}',
  '1 set will be deleted.': 'Будет удалён 1 подход.',
  '{0} sets will be deleted.': 'Будет удалено подходов: {0}.',
  'unchecked': 'не отмечен',
  'Delete set': 'Удалить подход',
  'Restore set': 'Вернуть подход',
  'Restore exercise': 'Вернуть упражнение',
  'Finish workout': 'Завершить тренировку',
  'Start workout': 'Начать тренировку',
  'today is {0}': 'сегодня — {0}',
  'already trained today · {0}': 'сегодня уже тренировался · {0}',
  ...
  'Pick the day you trained. For anything older, open the calendar and tap the day.': 'Выбери день, когда тренировался. Для более старых дней открой календарь и коснись дня.',
  'planned: {0}': 'по плану: {0}',
  'What did you train? The sets come in at your usual numbers — correct them, then finish as normal.': 'Что ты тренировал? Подходы придут с твоими обычными числами — поправь их и заверши как обычно.',
  'planned': 'по плану',
  'add the exercises yourself': 'упражнения добавишь сам',
  'Finish or discard the workout you have open first': 'Сначала заверши или отмени открытую тренировку',
  'Log a workout for this day': 'Записать тренировку за этот день',
  'Add an exercise you forgot': 'Добавить забытое упражнение',
  'Added to {0}': 'Добавлено в {0}',
  'logging {0}': 'записываешь {0}',
  'Save this workout': 'Сохранить эту тренировку',
  'Saved to {0}': 'Сохранится на {0}',
  '{0} — logging {1}': '{0} — записываешь {1}',
  ...
  'Finish workout · {0} exercises done': 'Завершить тренировку · {0} упражнений выполнено',
  ...
  'Duplicate exercise': 'Дублировать упражнение',
  '{0} (copy)': '{0} (копия)',
  'A copy of “{0}” that is yours to change — rename it, fix the muscles, set the weight you actually use.': 'Копия «{0}», которую можно менять — переименуй, поправь мышцы, укажи вес, который реально используешь.',
  'It behaves like any other exercise. Everything here can be changed later.': 'Ведёт себя как любое другое упражнение. Всё здесь можно изменить позже.',
  ...
  'Show the animation': 'Показывать анимацию',
  'The copied clip from “{0}”.': 'Клип, скопированный из «{0}».',
  'Create copy': 'Создать копию',
  'Duplicate & edit': 'Дублировать и изменить',
  ...
  'No entries yet — log your weight to start the curve.': 'Записей пока нет — внеси свой вес, чтобы начать кривую.',
  'Edit this workout': 'Изменить эту тренировку',
}
