...
export default {
  ...
  'Mark them done if you trained them, then confirm how long the session took.': 'Hake sie ab, wenn du sie trainiert hast, und bestätige dann die Dauer.',
  'Every set is checked off. Confirm how long the session took.': 'Alle Sätze sind abgehakt. Bestätige die Dauer der Einheit.',
  'Finish workout': 'Training beenden',
  // --- workout view ---
