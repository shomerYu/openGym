...
export default {
  ...
  'New PR:': 'Nuevo récord:',
  'Nice!': '¡Genial!',
  'Mark all exercises done': 'Marcar todos los ejercicios como hechos',
  'Checks off every remaining set at the numbers already in the rows.': 'Marca cada serie restante con los números que ya están en las filas.',
  '{0} of {1} sets will be logged.': 'Se registrarán {0} de {1} series.',
  'Finish with nothing logged': 'Terminar sin registrar nada',
  'Keep training': 'Seguir entrenando',
  '{0} set is still unchecked.': 'Queda {0} serie sin marcar.',
  '{0} sets are still unchecked.': 'Quedan {0} series sin marcar.',
  'Mark them done if you trained them, delete the ones you didn’t, then confirm how long the session took.': 'Márcalas si las entrenaste, elimina las que no, y luego confirma cuánto duró la sesión.',
  'Every set is checked off. Delete anything that shouldn’t be saved, then confirm how long the session took.': 'Todas las series están marcadas. Elimina lo que no quieras guardar y confirma cuánto duró la sesión.',
  'Review & delete sets': 'Revisar y eliminar series',
  '{0} deleted': '{0} eliminadas',
  'Delete the unchecked set': 'Eliminar la serie sin marcar',
  'Delete the {0} unchecked sets': 'Eliminar las {0} series sin marcar',
  '1 set will be deleted.': 'Se eliminará 1 serie.',
  '{0} sets will be deleted.': 'Se eliminarán {0} series.',
  'unchecked': 'sin marcar',
  'Delete set': 'Eliminar serie',
  'Restore set': 'Restaurar serie',
  'Restore exercise': 'Restaurar ejercicio',
  'Finish workout': 'Terminar entrenamiento',
  'Start workout': 'Empezar entrenamiento',
  'today is {0}': 'hoy toca {0}',
  'already trained today · {0}': 'ya entrenaste hoy · {0}',
  ...
  'Pick the day you trained. For anything older, open the calendar and tap the day.': 'Elige el día que entrenaste. Para días más antiguos, abre el calendario y toca el día.',
  'planned: {0}': 'planificado: {0}',
  'What did you train? The sets come in at your usual numbers — correct them, then finish as normal.': '¿Qué entrenaste? Las series entran con tus números habituales — corrígelas y termina como siempre.',
  'planned': 'planificado',
  'add the exercises yourself': 'añade tú los ejercicios',
  'Finish or discard the workout you have open first': 'Termina o descarta el entrenamiento que tienes abierto',
  'Log a workout for this day': 'Registrar un entrenamiento para este día',
  'Add an exercise you forgot': 'Añadir un ejercicio que olvidaste',
  'Added to {0}': 'Añadido a {0}',
  'logging {0}': 'registrando {0}',
  'Save this workout': 'Guardar este entrenamiento',
  'Saved to {0}': 'Se guardará en {0}',
  ...
  'Finish workout · {0} exercises done': 'Terminar entrenamiento · {0} ejercicios hechos',
  ...
  'Workout layout': 'Vista del entrenamiento',
  'Focus': 'Enfoque',
  'List': 'Lista',
  'Sounds': 'Sonidos',
  ...
  '{0} (copy)': '{0} (copia)',
  'A copy of “{0}” that is yours to change — rename it, fix the muscles, set the weight you actually use.': 'Una copia de «{0}» que es tuya para cambiar: renómbrala, corrige los músculos, pon el peso que usas de verdad.',
  'It behaves like any other exercise. Everything here can be changed later.': 'Se comporta como cualquier otro ejercicio. Todo esto se puede cambiar después.',
  'Body part': 'Parte del cuerpo',
  'Bodyweight exercises log reps only — add a weight below if you use a belt.': 'Los ejercicios de peso corporal solo registran repeticiones: añade un peso abajo si usas cinturón.',
  'Main muscle': 'Músculo principal',
  'It’s a stretch': 'Es un estiramiento',
  'Stretch': 'Estiramiento',
  'About': 'Acerca de',
  'Version': 'Versión',
  'build {0}': 'compilación {0}',
  'Still logged, but it won’t count toward the muscles you trained.': 'Se sigue registrando, pero no cuenta para los músculos que entrenaste.',
  'Also works': 'También trabaja',
  'Default weight ({0})': 'Peso por defecto ({0})',
  'What a new plan starts this exercise at. Leave at 0 to decide per plan.': 'Con lo que un plan nuevo empieza este ejercicio. Déjalo en 0 para decidirlo en cada plan.',
  'Show the animation': 'Mostrar la animación',
  'The copied clip from “{0}”.': 'El clip copiado de «{0}».',
  ...
  'Edit this workout': 'Editar este entrenamiento',
}
