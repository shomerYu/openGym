...
export default {
  ...
  'Mark them done if you trained them, then confirm how long the session took.': 'Márcalas si las entrenaste y luego confirma cuánto duró la sesión.',
  'Every set is checked off. Confirm how long the session took.': 'Todas las series están marcadas. Confirma cuánto duró la sesión.',
  'Finish workout': 'Terminar entrenamiento',
