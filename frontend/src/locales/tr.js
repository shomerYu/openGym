...
export default {
  ...
  'New PR:': 'Yeni rekor:',
  'Nice!': 'Süper!',
  'Mark all exercises done': 'Tüm egzersizleri yapıldı olarak işaretle',
  'Checks off every remaining set at the numbers already in the rows.': 'Kalan her seti satırlarda yazan değerlerle işaretler.',
  '{0} of {1} sets will be logged.': '{1} setin {0} tanesi kaydedilecek.',
  'Finish with nothing logged': 'Hiçbir şey kaydetmeden bitir',
  'Keep training': 'Antrenmana devam et',
  '{0} set is still unchecked.': '{0} set hâlâ işaretlenmedi.',
  '{0} sets are still unchecked.': '{0} set hâlâ işaretlenmedi.',
  'Mark them done if you trained them, delete the ones you didn’t, then confirm how long the session took.': 'Yaptıklarını işaretle, yapmadıklarını sil, sonra antrenmanın ne kadar sürdüğünü onayla.',
  'Every set is checked off. Delete anything that shouldn’t be saved, then confirm how long the session took.': 'Tüm setler işaretli. Kaydedilmemesi gerekenleri sil, sonra süreyi onayla.',
  'Review & delete sets': 'Setleri gözden geçir ve sil',
  '{0} deleted': '{0} silindi',
  'Delete the unchecked set': 'İşaretlenmemiş seti sil',
  'Delete the {0} unchecked sets': 'İşaretlenmemiş {0} seti sil',
  '1 set will be deleted.': '1 set silinecek.',
  '{0} sets will be deleted.': '{0} set silinecek.',
  'unchecked': 'işaretlenmedi',
  'Delete set': 'Seti sil',
  'Restore set': 'Seti geri getir',
  'Restore exercise': 'Egzersizi geri getir',
  'Finish workout': 'Antrenmanı bitir',
  ...
  'Log a past workout': 'Geçmiş bir antrenmanı kaydet',
  'Pick the day you trained. For anything older, open the calendar and tap the day.': 'Çalıştığın günü seç. Daha eskisi için takvimi aç ve o güne dokun.',
  'planned: {0}': 'planlanan: {0}',
  'What did you train? The sets come in at your usual numbers — correct them, then finish as normal.': 'Ne çalıştın? Setler her zamanki sayılarınla gelir — düzelt, sonra normal şekilde bitir.',
  'planned': 'planlanan',
  'add the exercises yourself': 'egzersizleri kendin ekle',
  'Finish or discard the workout you have open first': 'Önce açık olan antrenmanı bitir veya sil',
  'Log a workout for this day': 'Bu gün için antrenman kaydet',
  'Add an exercise you forgot': 'Unuttuğun bir egzersizi ekle',
  'Added to {0}': '{0} gününe eklendi',
  'logging {0}': '{0} kaydediliyor',
  'Save this workout': 'Bu antrenmanı kaydet',
  'Saved to {0}': '{0} gününe kaydedilecek',
  '{0} — logging {1}': '{0} — {1} kaydediliyor',
  ...
  'Finish workout · {0} exercises done': 'Antrenmanı bitir · {0} egzersiz yapıldı',
  ...
  'Workout layout': 'Antrenman görünümü',
  'Focus': 'Odak',
  'List': 'Liste',
  'Sounds': 'Sesler',
  ...
  'Duplicate exercise': 'Egzersizi çoğalt',
  '{0} (copy)': '{0} (kopya)',
  'A copy of “{0}” that is yours to change — rename it, fix the muscles, set the weight you actually use.': '“{0}” egzersizinin sana ait bir kopyası — adını değiştir, kasları düzelt, gerçekten kullandığın ağırlığı gir.',
  'It behaves like any other exercise. Everything here can be changed later.': 'Diğer egzersizler gibi davranır. Buradaki her şey sonradan değiştirilebilir.',
  ...
  'Show the animation': 'Animasyonu göster',
  'The copied clip from “{0}”.': '“{0}” egzersizinden kopyalanan klip.',
  'Create copy': 'Kopya oluştur',
  'Duplicate & edit': 'Çoğalt ve düzenle',
  ...
  'Edit this workout': 'Bu antrenmanı düzenle',
}
