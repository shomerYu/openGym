...
export default {
  ...
  'Mark them done if you trained them, then confirm how long the session took.': 'अगर आपने किए हैं तो निशान लगाएँ, फिर पुष्टि करें कि सेशन में कितना समय लगा।',
  'Every set is checked off. Confirm how long the session took.': 'सभी सेट चेक हो चुके हैं। पुष्टि करें कि सेशन में कितना समय लगा।',
  'Finish workout': 'वर्कआउट समाप्त करें',
