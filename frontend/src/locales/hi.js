...
export default {
  ...
  'New PR:': 'नया रिकॉर्ड:',
  'Nice!': 'बहुत बढ़िया!',
  'Mark all exercises done': 'सभी एक्सरसाइज़ पूरी के रूप में चिह्नित करें',
  'Checks off every remaining set at the numbers already in the rows.': 'पंक्तियों में पहले से मौजूद संख्याओं के साथ हर बचे हुए सेट पर निशान लगाता है।',
  '{0} of {1} sets will be logged.': '{1} में से {0} सेट दर्ज किए जाएंगे।',
  'Finish with nothing logged': 'बिना कुछ दर्ज किए समाप्त करें',
  'Keep training': 'ट्रेनिंग जारी रखें',
  '{0} set is still unchecked.': '{0} सेट अभी भी अनचेक है।',
  '{0} sets are still unchecked.': '{0} सेट अभी भी अनचेक हैं।',
  'Mark them done if you trained them, delete the ones you didn’t, then confirm how long the session took.': 'जो आपने किए उन पर निशान लगाएँ, जो नहीं किए उन्हें हटाएँ, फिर पुष्टि करें कि सेशन में कितना समय लगा।',
  'Every set is checked off. Delete anything that shouldn’t be saved, then confirm how long the session took.': 'हर सेट पर निशान लगा है। जो सहेजना नहीं है उसे हटाएँ, फिर सेशन की अवधि की पुष्टि करें।',
  'Review & delete sets': 'सेट देखें और हटाएँ',
  '{0} deleted': '{0} हटाए गए',
  'Delete the unchecked set': 'अनचेक सेट हटाएँ',
  'Delete the {0} unchecked sets': '{0} अनचेक सेट हटाएँ',
  '1 set will be deleted.': '1 सेट हटाया जाएगा।',
  '{0} sets will be deleted.': '{0} सेट हटाए जाएँगे।',
  'unchecked': 'अनचेक',
  'Delete set': 'सेट मिटाएँ',
  'Restore set': 'सेट वापस लाएँ',
  'Restore exercise': 'व्यायाम वापस लाएँ',
  'Finish workout': 'वर्कआउट समाप्त करें',
  ...
  'Log a past workout': 'पिछली वर्कआउट दर्ज करें',
  'Pick the day you trained. For anything older, open the calendar and tap the day.': 'वह दिन चुनें जब आपने ट्रेनिंग की थी। उससे पुराने दिन के लिए कैलेंडर खोलें और उस दिन को टैप करें।',
  'planned: {0}': 'योजना: {0}',
  'What did you train? The sets come in at your usual numbers — correct them, then finish as normal.': 'आपने क्या किया? सेट आपके सामान्य नंबरों के साथ आते हैं — उन्हें सुधारें, फिर हमेशा की तरह पूरा करें।',
  'planned': 'योजना',
  'add the exercises yourself': 'व्यायाम खुद जोड़ें',
  'Finish or discard the workout you have open first': 'पहले खुली हुई वर्कआउट पूरी करें या छोड़ें',
  'Log a workout for this day': 'इस दिन की वर्कआउट दर्ज करें',
  'Add an exercise you forgot': 'छूटा हुआ व्यायाम जोड़ें',
  'Added to {0}': '{0} में जोड़ा गया',
  'logging {0}': '{0} दर्ज हो रही है',
  'Save this workout': 'यह वर्कआउट सहेजें',
  'Saved to {0}': '{0} में सहेजा जाएगा',
  '{0} — logging {1}': '{0} — {1} दर्ज हो रही है',
  ...
  '{0} exercises · {1} sets': '{0} एक्सरसाइज़ · {1} सेट',
  ...
  'Finish workout · {0} exercises done': 'वर्कआउट समाप्त करें · {0} एक्सरसाइज़ पूरी',
  ...
  'Duplicate exercise': 'एक्सरसाइज़ डुप्लिकेट करें',
  '{0} (copy)': '{0} (प्रति)',
  'A copy of “{0}” that is yours to change — rename it, fix the muscles, set the weight you actually use.': '“{0}” की एक प्रति जो आपकी है — नाम बदलें, मांसपेशियाँ ठीक करें, वह वज़न सेट करें जो आप सचमुच उठाते हैं।',
  'It behaves like any other exercise. Everything here can be changed later.': 'यह किसी भी दूसरी एक्सरसाइज़ की तरह काम करती है। यहाँ सब कुछ बाद में बदला जा सकता है।',
  ...
  'Show the animation': 'एनिमेशन दिखाएँ',
  'The copied clip from “{0}”.': '“{0}” से कॉपी किया गया क्लिप।',
  'Create copy': 'प्रति बनाएँ',
  ...
  'No entries yet — log your weight to start the curve.': 'अभी कोई प्रविष्टि नहीं — वक्र शुरू करने के लिए अपना वज़न दर्ज करें।',
  'Edit this workout': 'यह वर्कआउट संपादित करें',
}
